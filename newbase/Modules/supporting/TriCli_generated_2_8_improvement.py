...
class FalconChatCLI:
    ...
    def format_prompt(self, message, history, system_prompt):
        prompt = ""
        if system_prompt:
...
Falcon:"""
    ...
    def generate(
        self, prompt, history, system_prompt="", temperature=0.9, max_new_tokens=256, top_p=0.95, repetition_penalty=1.0,
    ):
